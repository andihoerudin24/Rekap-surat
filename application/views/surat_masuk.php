...
<table border="0" cellpadding="5" cellspacing="0" height="500px">
        <tbody>
            <tr>
                <td>No</td>
                <td>:</td>
                <td><input type="text" class="form-control" name="no"   maxlength="50" required="required" /></td>
            </tr>
            <tr>
                <td>Dari</td>
                <td>:</td>
                <td><input type="text" class="form-control" name="asal_surat"   maxlength="50" required="required" /></td>
            </tr>
            <tr>
                <td>Perihal</td>
                <td>:</td>
                <td><input type="text" class="form-control" name="prihal"  maxlength="100" required="required" /></td>
            </tr>
            <tr>
                <td>Tanggal Surat</td>
                <td>:</td>
